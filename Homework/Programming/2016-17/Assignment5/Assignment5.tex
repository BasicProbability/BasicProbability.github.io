...
settings from  iteration $ t-1 $.
\item[3 points] The log-likelihood increases monotonically when the algorithm is run. It's ok if after a couple of iterations the log-likelihood
